...
int main(int argc, char** argv) {
  ...
  try {
    ...
    auto cartesian_pose_callback = [=, &time, &acceleration_limit, &jerk_limit, &last_force, &velocity_array, &print_data, &desired_force, &error, &past_error, &integral, &derivative, &vel_desired, &vel_desired_previous, &acc, &acc_previous, &jerk, &pd, &pid_constants, &running]
