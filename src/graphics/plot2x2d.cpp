...
static float C_MIN_LSB = -5;
static float C_MAX_LSB = 5;
...
//  glewExperimental = true;
	...
	glBufferData(GL_ARRAY_BUFFER, buffersize*2, NULL, GL_DYNAMIC_DRAW);
 ...
 */
GLint graph_update1(double mainValue, int _dataTail, GLuint vertexBuffers, int id) {
